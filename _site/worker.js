...
var DEFAULT_CACHE = 'tramdisseny-app-cache2015-03-25T11:44:48+01:00';
var AIP_CACHE = 'tramdisseny-aip-cache2015-03-25T11:44:48+01:00';
  ...
  event.waitUntil(
    caches.open(DEFAULT_CACHE).then(function(cache) {
      return cache.addAll([
        ...
        '/inscripcions/2015/03/12/formulari-inscripcio-del-participant-al-premi-tram-disseny-2015/'
